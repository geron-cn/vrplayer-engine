...
public:
    ...
    inline Matrix getHeadViewMatrix();
    ...
    float getDesiredFPS() const { return 0.001f / _updateInterval; }
    
    void setLiveURL(const std::string& url) { _liveURL = url; }
    
    const std::string& getLiveURL() const { return _liveURL; }
...
private:
    ...
    float _updateInterval;                      //update interval ms
