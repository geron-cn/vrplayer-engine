...
//  VRLive
//
//  Created by gero on 4/30/16.
//
//

#ifndef __VIDEOSTATE_CPP_
#define __VIDEOSTATE_CPP_
...
//    }
//
//    static void duplicate_right_border_pixels(SDL_Texture *bmp) {
//        int i, width, height;
//        Uint8 *p, *maxp;
//        for (i = 0; i < 3; i++) {
//            width  = bmp->width;
...
//                     ":channel_layout=0x%"PRIx64,  is->audio_filter_src.channel_layout);
    ...
    static int decoder_start(Decoder *d, int (*fn)(void *), void *arg)
    {
        ...
        d->decoder_tid = SDL_CreateThread(fn, "decoder thread", arg);
        if (!d->decoder_tid) {
...
//                   is->audio_clock, audio_clock0);
    ...
    static VideoState *stream_open(const char *filename, AVInputFormat *iformat)
    {
        ...
        is->read_tid     = SDL_CreateThread(read_thread, "reade stream", is);
        if (!is->read_tid) {
