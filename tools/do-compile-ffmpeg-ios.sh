...
source $SCRIP_DIR/config/module.sh
...
FF_BUILD_SOURCE=$SCRIP_DIR/../FFmpeg
FF_BUILD_PREFIX="$FF_BUILD_ROOT/$FF_BUILD_NAME"
...
echo "[*] check OpenSSL"
echo "----------------------"
FFMPEG_DEP_OPENSSL_INC=$FF_BUILD_ROOT/$FF_BUILD_NAME_OPENSSL/include
FFMPEG_DEP_OPENSSL_LIB=$FF_BUILD_ROOT/$FF_BUILD_NAME_OPENSSL/lib
#--------------------
# with openssl
